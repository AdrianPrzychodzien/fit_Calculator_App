...
const DietTable: React.FC<Props> = ({ diet, kcalAmount }) => {
  ...
  switch (diet) {
    case 'Medium Carb':
      ...
      break;
    case 'Low Carb':
      tableData = [macro, [LowCarbDiet[0], LowCarbDiet[1], LowCarbDiet[2]]];
      break;
    case 'High Carb':
      tableData = [macro, [HighCarbDiet[0], HighCarbDiet[1], HighCarbDiet[2]]];
      break;
    default:
      break;
  }
  ...
  return (
    <View style={globalStyles.container}>
      <View>
        ...
        <Table>
          <Row widthArr={[120, 120, 120]} textStyle={styles.text} />
        </Table>
        <ScrollView>
          <Table>
