...
const HealthTipsInfo = ({ healthTips, dailyWeightArray, clearFinish, style }) => {
    ...
    <>
        ...
        <View style={globalStyles.container}>
          ...
          <View style={styles.modalParagraph}>
            <Text style={styles.text}>
              According to the entered data you {info} in {days} days,
              which forces you to change your body weight
              by {(kgAmout / days).toFixed(2)}kg per day{' '}
              ({(kgAmout / days * 7).toFixed(2)}kg per week)
            </Text>
            <Text style={styles.text}>
            ...
            {rapidWeightChange ? (
              <>
                <Text style={styles.text}>You will need to change weight too quickly!
                      Consider slowing down to prevent side effects, like yo-yo effect.
                        </Text>
                <Text style={styles.text}>Mayby you should extend timeline?</Text>
              </>
            ) : (
                <Text style={styles.text}>
      ...
      <View style={style}>
        <Button
          ...
          title={rapidWeightChange ? `Fast pace of weight change!` : 'Healthy pace of weight change'}
        />
      </View>
    </>
  )
