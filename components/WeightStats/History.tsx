...
const History: React.FC<Props> = ({ navigation }) => {
  ...
  dailyWeightArray
    ...
    .map((item, index) => {
      ...
      const fontIcon = (color: string, fa: any) => (
          ...
          <View style={styles.legend}>
            <View style={styles.colors}>
              ...
              <View style={styles.container}>
                <Text style={{ ...styles.color, color: 'purple' }}>
                  Purple color:
                </Text>
              ...
              <View style={styles.container}>
                <Text style={{ ...styles.color, color: 'blue' }}>
                  Blue color:
                </Text>
              ...
              <View style={styles.container}>
                <Text style={{ ...styles.color, color: 'lightblue' }}>
                  Light blue color:
                </Text>
              ...
              <View style={styles.container}>
                <Text style={{ ...styles.color, color: 'orange' }}>
                  Orange color:
                </Text>
              ...
              <View style={styles.container}>
                <Text style={{ ...styles.color, color: 'red' }}>
                  Red color:
                </Text>
                <Text>Obese</Text>
              </View>
